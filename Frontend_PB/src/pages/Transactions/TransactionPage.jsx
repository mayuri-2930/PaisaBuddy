  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        {/*
          Pass spendableBalance so the form blocks submission when ₹0.
          In full (non-compact) mode the form sits at the top of the page.
        */}
        <AddTransactionForm
